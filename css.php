...
<html lang="da">
    ...
    <?php include "menu.inc" ?>    
        ...
        <div id="genereltcss"> <!--Generelt om CSS-->
            ...
            <p class="tekst"> CSS står for cascading style sheet. Det er et kodesprog vi bruger til at style vores HTML. Det smarte ved at bruge CSS er, at vi kan adskille struktur (HTML) og udseende (CSS). Man opretter et HTML dokument, hvor man henviser til sit CSS stylesheet.  På den måde forstår HTML´en, hvor den skal hente udseende eller stylingen fra.</p> 
           ...
           <p class="tekst"> Et stylesheet er en samling af regler, som hele tiden kan overskrides. Det er det vi kalder kaskaderegler. Det seneste vi bestemmer, er det der gælder.</p> 
            ...
            <p class="tekst">Den tredje måde er inline CSS. Her skriver man CSS´en ind i HTML. Det gør man ved at vælge attributten style, og herefter vælges en attributværdi. Det er ikke fremgangsmåde der er efterstræbelsesværdig, da den hurtig bliver upraktisk, og svær at læse.</p> 
        ...
        <div id="syntaks"> <!--CSS syntaks start-->
            ...
            <p class="tekst"> CSS-syntaks handler om den grammatik, der er i CSS. Her er der nogle forskellige begreber, som er vigtig at have styr på.</p>  
            
            <p class="tekst"> En selector angiver, hvad det er man ønsker at style. Der findes fire forskellige selector. </p>
            
            <p class="tekst">
            1.	Element selector fokuserer på almindelige tags såsom body, h1, p, article osv.  
            2.	Id selector bruges, når det er et helt specifikt emne man vil style. Man mærker op med et id inde i html, og inde i CSS skriver man et #. 
            3.	Class selector bruges, når man ønsker at style flere elementer på samme måde. Dette gøres ved at man skriver en class inde i tagget i html, og sætter et punktum inde i CSS. 
            4.	Pseudo selector kan f.eks. være når, man bruger hover. 
            </p>  
            
            <p class="tekst"> Derudover er der en række deklarationer, som bruges til at fortælle, hvorfra man gerne vil foretage en specifik styling. En deklaration startes med en krøllet parentes { og sluttes med en krøllet parentes }. Inde for disse parenteser har vi nogle properties (egenskaber) og values (værdier), som i øvrigt er adskilt at et kolon. Propertyen bestemmer, hvad vi gerne vil style, det kunne f.eks. være back-ground color, og valuen er selve farven, det kunne f.eks. være blue. Efter valuen sætter man et semikolon, der afslutter valuen. </p>  
