...
<html lang="da">
    <head> 
        ...
        <title>Farve og Typografi</title>
        <?php include "overordnet.inc" ?>
        <link rel="stylesheet" href="CSS/farve.css">
    ...
    <?php include "menu.inc" ?>    
        ...
        <div id="indledningfarve"> <!--indledningfarve start-->
            ...
            <p class="tekst">Det er derfor vigtigt, at vi forstår, hvilken effekt farver og typografi har på kunder og forbrugere.</p> 
              
        </div>  <!--indledningfarve slut-->
            
            
            
            
        <div id="typografi"> <!--typografi start-->
            <h2> Typografi </h2> 
            
            <p class="tekst">Det er ikke kun skrifttypen. Det gælder også fonte, kolonner, læsbarhed, billeder, logo osv.</p>
            
            <p class="tekst">Typografi handler ligeså meget om det samlede visuelle indtryk. </p>
            
            <p class="tekst">Det er vores førstehåndsindtryk, når vi skimmer en artikel eller et website, der er afgørende for om vi gider at læse den. Vores underbevidsthed bemærker læsbarhed, skrifttyper, whitespace osv.</p>
        ...
        <div id="typeface"> <!--typeface  start-->
            <h2> Fonts og Weigths udgør tilsammen et typeface </h2> 
        ...
        <div id="rettigheder"> <!--rettigheder start-->
            <h2> Husk rettigheder</h2> 
        ...
        <div id="typefacecontainer">
                ...
                <img id="typebillede" class="allebilleder" src="Billeder/typebillede.jpg">
                
                <blockquote>Model til at kombinere fonts og weights ↑</blockquote>            
            </div>     
            
        </div>  <!--rettigheder slut-->  
        ...
        <div id="farvelare"> <!--Farvelære start-->
           ...
           <div id="farvehjulet"> <!--Farvehjulet start-->
            <h2> Farvehjulets Opbygning </h2> 
               
            <p class="tekst">Det her farvehjul har jeg selv tegnet i Photoshop. Det gjorde vi den dag, vi havde og om Typografi og Farvelære med Carsten.</p>            
        ...
        <div id="farvehjulcontainer"> 
                ...
                <img id="farvehjul" class="allebilleder" src="Billeder/farvehjul.jpg">
            ...
            <p class="tekst">Sekundærfarver opstod ved at blande to primærfarver f.eks. rød og blå som giver farven lilla. De andre sekundærfarver er gul (grøn og rød) og lyseblå (blå og grøn). </p>   
            
            <p class="tekst">De tertiære farver blev placeret yderst i farvecirklen. Det er farver som er blandet af en primærfarve og en sekundærfarve f.eks. orange som er blandet af rød(primær) og gul(sekundær)</p>   
               
            <p class="tekst"> De farver som ligger overfor hinanden kaldes for komplementære farver. Det kunne f.eks. være blå og gul. Det skaber en optisk kontrast, som ofte kan findes i naturen.</p>
               
               
               
            
        </div>  <!--Farvehjulet slut-->     
            
            
        <div id="farverum"> <!--Farverum start-->
            <h2>Farverum</h2> 
        ...
        <div id="cmykcontainer"> 
            
                <img id="cmyk" class="allebilleder" src="Billeder/cmyk.jpg">
                           
                <blockquote>CMYK</blockquote>
        </div>     
            
            <h2>RGB</h2>
            
            <p class="tekst"> Hvis man blander de tre primærfarver, med maximum værdi (255) så får man farven hvid. 
            RGB bruges til skærme.</p>
            
         <div id="rgbcontainer"> 
            
                <img id="rgb" class="allebilleder" src="Billeder/rgb.jpg">
                           
                <blockquote>RGB</blockquote>
        </div>     
        ...
        <div id="kulor"> <!--Kulør start-->
            <h2>Kulør, Mæthed og Lyshed</h2> 
            
            <p class="tekst"> Kulør er en variation af en farve, eller en graduering af en farve. </p>
            
            <p class="tekst"> Mæthed: Farven blandes med forskellige mængder af gråtoner. </p>
         ...
         <div id="farvepalettecontainer"> 
                ...
                <img id="farvepalette" class="allebilleder" src="Billeder/farvepalette.jpg">
                           
                <blockquote>I Photoshop har vi arbejdet med Kulør, Mæthed og Lyshed</blockquote>
        </div>         
        ...
        <div id="farvesamcontainer"> 
                ...
                <img id="farvesam" class="allebilleder" src="Billeder/farvesam.jpg">
                           
                <blockquote>Denne model kan bruges til at se forskellige farvesammensætninger</blockquote>
        </div>  
            
            <p class="tekst"> Vi fik til opgave at tegne 11 spøgelser, hvor vi skulle bruge forskellige typografier og farver til at beskrive stemningerne ond, venlig, vigtig, stærk, blød, maskulin, feminin, barnlig, streng, alvorlig og kedelig</p>
            
        <div id="stemningercontainer"> 
            
                <img id="stemninger" class="allebilleder" src="Billeder/stemninger.jpg">
                           
                <blockquote>De 11 forskellige spøgelser jeg tegnede i Photoshop</blockquote>
        </div>  
            
            <p class="tekst"> Til f.eks. det onde spøgelse valgte jeg farven sort, som kan symbolisere forskellige ting bl.a. eksklusivitet, rigdom, elegance osv. Men det kan også symbolisere noget ondt, skræmmende, mørke osv. Derfor synes jeg, at farven passede godt til det "onde spøgelse"</p>
            
         <div id="ghostondcontainer"> 
            
                <img id="ghostond" class="allebilleder" src="Billeder/ghostond.jpg">
                           
                <blockquote>Det "onde spøgelse"</blockquote>
        </div>     
            
            
            
        
        </div>  <!--Farvesammensætning farver-->      
            ...
            <div id="felt23"> &nbsp;</div> <!--holder footer nede på siden-->     
        </div> <!--pagewrap slut-->
