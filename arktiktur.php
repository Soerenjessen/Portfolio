...
<html lang="da">
    <head> 
        ...
        <link rel="stylesheet" href="CSS/arkitektur.css">
    ...
    <?php include "menu.inc" ?>    
        ...
        <div id="iarkitektur"> <!--Informationsarkitektur start-->
            ...
            <p class="tekst"> -	Tid: Her organiserer man efter tid eller historik - Det kunne f.eks. være en tidslinje. Lidt ligesom det eksempel vi så med Pink Floyds pladeudgivelser. </p> 
            
            <p class="tekst"> -	Kategori: Her gælder det om at organisere efter relaterede emner eller fællestræk. F.eks. i supermarkeder, her er afdelinger i butikken typisk kategorisk opdelt. I føtex kan man finde en bager, slagter, frugt og grønt, elektronik osv.</p> 
        ...
        <div id="iaeksempel1"> <!--Iaeksempel 1 start-->
            <h2> Eksempel </h2> 
            
            <p class="tekst"> På klassen arbejdede vi med organisering af en pladebutik. Her fandt vi ud af, at der er mange forskellige måder at organisere en pladebutik. De fleste pladebutikker er opdelt efter flere forskellige sorteringer. Først og fremmest er de fleste pladebutikker opdelt efter kategori såsom pop, rock, blues, jazz osv. Derudover kan de også være opdelt efter årstal, her bruger man sortering af tid. Derforuden har de fleste pladeforretninger også sorteret efter alfabetisk rækkefølge. 
            </p>  
        ...
        <div id="kortcontainer1">
            ...
            <img id="kort1" class="allebilleder" src="Billeder/kort1.jpg">
            
             <blockquote> Billede af Brainstormprocessen</blockquote>
            
        </div>
            
        <div id="kortcontainer2">
            
            <img id="kort2" class="allebilleder" src="Billeder/kort2.jpg">
            
            <blockquote> Første testpersons sortering</blockquote>
            
        </div>
            
        <div id="kortcontainer3">
            
            <img id="kort3" class="allebilleder" src="Billeder/kort3.jpg">
            
            <blockquote> Anden testpersons sortering</blockquote>
            
        </div>    
            
            <p class="tekst"> Man kunne med fordel også have brugt gangstertesten til at undersøge, hvordan folk umiddelbart vil navigere, når de kommer ind på en side de aldrig har besøgt før. 
            </p>  
            
        </div>  <!--Iaeksempel 2 slut-->    
        ...
        <div id="iaeksempel3"> <!--Iaeksempel 3 start-->
            ...
            <p class="tekst"> Det blev hele tiden mere besværligt at opfinde nye kategorier, og beskrivende kategorinavne. Vi kunne derfor konkludere, at det ikke var en speciel hensigtmæssig måde at opdele Lego på, da det hurtigt blev forvirrende for os selv, og i sidste ende for brugerne.</p> 
            
        <div id="legosortcontainer">
            
            <img id="legosort" class="allebilleder" src="Billeder/legosort.jpg">
            
            <blockquote>Opdeling af Lego efter form og funktion</blockquote>
            
        </div>   
            
            <p class="tekst"> Andre studerende på holdet opdelte deres Lego efter nogle andre metoder. Bl.a. var der mange der opdelte efter farve i stedet for former og funktion.   
            </p>  
            
            <p class="tekst">Det smarte ved at opdele Lego efter farver, var at det var nemmere at placere klodserne uanset funktion og form. Set fra et brugerperspektiv var denne metode meget lettere at gennemskue, og da Niels kom rundt med nye klodser, var disse en del nemmere at placere</p>  
            
            
         <div id="legosort2container">
            
            <img id="legosort2" class="allebilleder" src="Billeder/legosort2.jpg">
            
            <blockquote>Farveopdeling af Lego </blockquote>
            
        </div>       
            
            <p class="tekst">Der var også nogle på holdet, som inddelte deres Lego efter form. Denne type kategoriopdeling fungerede også ganske udmærket.</p> 
            
            <p class="tekst">Der hvor det blev svært, var når man ville inddele efter flere forskellige kategorier f.eks. form og funktion.</p>  
            
        <div id="legosort3container">
            
            <img id="legosort3" class="allebilleder" src="Billeder/legosort3.jpg">
            
            <blockquote>Opdeling af Lego efter form</blockquote>
        ...
        </div>  <!--Iaeksempel 3 slut-->   
            
             <div id="felt10"> &nbsp;</div> <!--holder footer nede på siden-->
