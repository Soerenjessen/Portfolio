...
<html lang="da">
    ...
    <?php include "menu.inc" ?>    
        ...
        <div id="planl"> <!--Planlægning og Overordnet design start-->
         ...
         </div>  <!--Planlægning og Overordnet design slut--> 
        ...
        <div id="isbraincontainer">
            
            <img id="isbrain" class="allebilleder" src="Billeder/isbrain.jpg">
            
            <blockquote> Brainstorm til Det Bette Ismejeri</blockquote>
        ...
        <div id="user"> <!--User Stories start-->
            <h1> User Stories </h1> 
            
            <p class="tekst"> Efter vi havde sorteret i vores ideer fra brainstormprocessen, begyndte vi at udarbejde User Stories. Fordelen ved User Stories er, at det giver et fælles sprog imellem alle involverede parter. Det eksempel vi brugte var (Som en bruger, skal/kan/vil/må, jeg ”handling” så jeg ”formål”). </p>   
            
        <div id="planusercontainer">
            
            <img id="planuser" class="allebilleder" src="Billeder/planuser.jpg">
            
            <blockquote> Eksempel: User Story fra One Page-projektet</blockquote>
            
        </div> 
            
            
        </div>  <!--User stories Tags slut-->
            
        <div id="feature"> <!--Feature unfeature list start-->
            <h1> Feature/Unfeature Liste </h1> 
        ...
        <div id="wireframes"> <!--Wireframes start-->
            <h1> Wireframes</h1> 
            
           <p class="tekst"> Da vi havde været igennem den indledende proces (Empathize/Define fase), begyndte vi at skitsere, hvordan Det bette Ismejeris hjemmeside kunne se ud. Vi startede med at tegne nogle wireframes, som skulle give et overordnet billede på, hvordan siden kunne se ud. </p> 
            
           <p class="tekst"> Wireframes er et skitseværktøj, som fokuser på navigation, funktion og indhold på siden. Man har ikke fokus på udseende, design, fremtoning osv. Derfor brugte vi ikke tid på at indsætte billeder, tekst, logoer osv. Her koncentrer man sig om skelettet til hjemmesiden, derfor er det ikke vigtigt at den ser godt ud rent grafisk, det ødelægger tværtimod tanken omkring et wireframe, som er en grov skitse. </p> 
        ...
        <div id="wireframecontainer">
            ...
            <img id="wireframe" class="allebilleder" src="Billeder/wireframe.jpg">
            
            <blockquote> Wireframe fra Det Bette Ismejeri</blockquote>
            
        </div>
            
            <div id="felt6"> &nbsp;</div> <!--holder footer nede på siden-->
