...
<html lang="da">
    <head> 
        ...
        <link rel="stylesheet" href="CSS/designthinking.css">
    ...
    <?php include "menu.inc" ?>    
        ...
        <div id="empathize"> <!--Empathize start-->
            <h2> Empathize </h2> 
            
            <p class="tekst"> Her skal man forsøge at opnå en empatisk forståelse af problemstillingen, uden at tænke i en færdig løsning. Det handler om at være nysgerrig, og tilsidesætte ens egne antagelser, for på den måde at kunne opnå en dybere indsigt i problemstillingen. Brugerinddragelse er en meget vigtig del af empathize fasen, og til dette har vi nogle forskellige metoder. Vi har arbejdet med deltagerobservation, interview, vær problemet, fem gange hvorfor osv.</p> 
        ...
        <div id="ideate"> <!--Ideate start-->
            <h2>Ideate</h2> 
            
            <p class="tekst"> Ideate fasen er her, hvor vi begynder at idegenerere og konceptualisere ud fra den viden, som vi har indsamlet i define og empathize fasen. Derefter kan vi begynde at tænke ud af boksen, og finde den bedste løsning til de problemstillinger vi har formuleret.</p> 
            
            <p class="tekst"> I den forbindelse bruger vi nogle forskellige metoder såsom Brainstorm, changeboards, kategorisering af ideer, benspænd osv.</p>
            
        </div>  <!--Ideate slut-->    
            
        <div id="prototype"> <!--Prototype start-->
            <h2>Prototype</h2> 
        ...
        <div id="tests"> <!--Test start-->
         ...
         <div id="implementering"> <!--Implementering start-->
            <h2>Implementering</h2> 
            
            <p class="tekst"> Det er denne fase, hvor man implementerer det givne produkt, der er udviklet i løbet af Design Thinking processen. Her videregiver man produktet og færdiggør processen.</p> 
            
        </div>  <!--Implementering slut-->  
        ...
        </div>  <!--Design Thinking Projektet slut-->  
            
            
        <div id="dag1"> <!--Dag 1 start-->
            <h2>Dag 1 - Empathize</h2> 
            
            <p class="tekst"> Første dag skulle vi finde en problemstilling, som indebar noget omkring ”reservation og udlån”. I den forbindelse startede vi med en brainstorm på 30 min. Hvor vi skrev alle ideer og tanker ned, uden at være afvisende overfor vilde ideer.  Vi var meget bevidste om at være divergente i den første brainstorm.</p> 
            
             <div id="brainstorm1container">
            
                <img id="brainstorm1" class="allebilleder" src="Billeder/brainstorm1.jpg">
                
                <blockquote> Den første brainstorm ↑</blockquote> 
            ...
            <div id="brainstorm2container">
                ...
                <img id="brainstorm2" class="allebilleder" src="Billeder/brainstorm2.jpg">
                
                <blockquote>Den anden Brainstorm ↑</blockquote> 
                        
            </div> 
            
            
             <p class="tekst"> Vi havde mange spændende ideer på bordet, alt lige fra ”udlån og reservation af musikinstrumenter” til ”frisørreservationer” osv.</p>
        ...
        <div id="dag2"> <!--Dag 2 start-->
            ...
            <div id="aarhus1container">
                ...
                <img id="aarhus1" class="allebilleder" src="Billeder/aarhus1.jpg">
                
                <blockquote>På vej i bilen til Aarhus ↑</blockquote> 
            ...
            <p class="tekst"> Det var bl.a. observationer på parkeringspladser, hvor vi betragtede og analyserede hvordan brugerne oplevede det at parkere i Aarhus C.</p>
             ...
             <div id="aarhus2container">
                ...
                <img id="aarhus2" class="allebilleder" src="Billeder/aarhus2.jpg">
                
                <blockquote>Parkeringsplads i Aarhus ↑</blockquote> 
            ...
            <div id="aarhus3container">
            
                <img id="aarhus3" class="allebilleder" src="Billeder/aarhus3.jpg">
                
                <blockquote>Vi leder efter parkeringsplads i Aarhus ↑</blockquote> 
                        
            </div> 
            
            
            <p class="tekst"> Efter en hel dag i Aarhus med interviews, observationer og egne oplevelser, var vi blevet meget klogere på vores problemstilling, og på vej hjem i bilen, begyndte vi at definere vores problemstilling. Vi var nu parate til define-fasen.</p>
            
            <p class="tekst"> Vi var tilbage på skolen sidst på eftermiddagen. Her fik vi kategoriseret vores data og defineret vores problemstilling omkring parkering. Til sidst blev der klippet en video sammen for dagen.</p>
            
            <p class="tekst"> Vil du læse vores samlede definition af problemet så se <a href="kategorisering.pdf">her</a> </p>
            
            
        </div>  <!--Dag 2 slut--> 
            
            
        <div id="dag3"> <!--dag 3 start-->
            <h2> Dag 3 - Ideate </h2> 
            
            <p class="tekst"> På tredje dagen skulle vi til at idegenere og konceptualisere, på baggrund af den data vi havde indsamlet på de første to dage (Empathize og Define). </p> 
            
            <p class="tekst"> Her startede vi igen med 4 x brainstorm, hvor vi skiftende havde været divergent og konvergent. </p> 
            
            <p class="tekst"> Herefter foretog vi en kategorisering af vores ideer, mest for at skabe et overblik, og se om der var sammenhæng imellem nogle af ideerne.  I den forbindelse tegnede vi et mindmap.</p>
            
            
            <div id="ideate1container">
            
                <img id="ideate1" class="allebilleder" src="Billeder/ideate1.jpg">
                
                <blockquote>Mindmap ↑</blockquote> 
                        
            </div>     
            
            <p class="tekst"> Vi producerede inspirationskort, som skulle inspirere os til andre vilde ideer.  </p> 
            
            <p class="tekst"> Vi brugte en feature/unfeature liste til at afgøre, hvad vores app skulle kunne, og hvad den ikke skulle kunne. </p> 
            
            <div id="ideate2container">
            
                <img id="ideate2" class="allebilleder" src="Billeder/ideate2.jpg">
            ...
            <div id="ideate3container">
                ...
                <img id="ideate3" class="allebilleder" src="Billeder/ideate3.jpg">
                
                <blockquote>Changeboard ↑</blockquote> 
                        
            </div>
            
            <p class="tekst">Grundlæggende set ville vi gerne udvikle en form for AirBnb til parkering.</p> 
                          
        </div>  <!--dag 3 slut-->  
            
            
        <div id="dag4"> <!--dag 4 start-->
            <h2> Dag 4 - Prototype og Test </h2> 
            
            <p class="tekst"> Nu skulle vi til at konkretisere vores ide via en prototype.
            Først skulle vi finde et navn til vores app, så vi startede dagen med et par brainstorms, og endte med navnet ”SmartPark”.</p>
            
            
            <div id="prototype1container">
            
                <img id="prototype1" class="allebilleder" src="Billeder/prototype1.jpg">
                
                <blockquote>Brainstorm omkring navn ↑</blockquote> 
                        
            </div> 
        
            <p class="tekst"> I forbindelse med prototypeudviklingen valgte vi primært at fokusere på wireframes, da vi ikke selv skulle kode en app. Derimod var det nogle datamatiker-studerende, som skulle tage opgaven videre derfra. Af den grund, var det vigtigt for os at få tydeliggjort vores tanker og ideer omkring SmartPark, hvilket gjorde det nemmere for datamatikerne at gå videre med kodedelen. </p>
            
            <div id="prototype2container">
            
                <img id="prototype2" class="allebilleder" src="Billeder/prototype2.jpg">
                
                <blockquote>Wireframe over SmartPark ↑</blockquote> 
           ...
           <div id="prototype3container">
                ...
                <img id="prototype3" class="allebilleder" src="Billeder/prototype3.jpg">
                
                <blockquote>Forside på SmartPark i Wireframe ↑</blockquote> 
        ...
        </div>  <!--dag 5 datamatikere slut-->
            
            
        <div id="dtrefleksion"> <!--refleksion start-->
            <h2>Refleksion over Design Thinking</h2> 
            ...
            <div id="felt24"> &nbsp;</div> <!--holder footer nede på siden-->     
        </div> <!--pagewrap slut-->
