...
<html lang="da">
    ...
    <?php include "menu.inc" ?>    
        ...
        <div id="generelt"> <!--Generelt om HTML-->
           ...
           <p class="tekst"> Når man arbejder med HTML-kodning foregår dette typisk i en Tekst-editor. En editor er det program man bruger til at skrive HTML koder i. Dette kunne f.eks. være Notepad++, textedit, brackets osv. Fælles for disse editorer er, at her arbejder man i ren tekst uden formatering.</p> 
        ...
        <div id="elementer"> <!--Elementer og Tags om HTML-->
            ...
            <p class="tekst"> En HTML kode består af en række elementer også kendt som tags. Hvert element har et åbningstag og et afslutningstag. Man bruger HTML elementer til at bestemme, hvad der skal ske med den tekst eller data imellem tagsene.</p> 
        ...
        <div id="overskriftcontainer">
         ...
         <div id="googlecontainer">
            ...
            <p class="tekst">Et andet element kunne være Body elementet, som beskriver selve indholdet, der er synligt på siden. Her vil starttagget se sådan ud &lt;body&gt; og sluttagget &lt;/body&gt;. Som sagt, alt hvad man skriver imellem body-elementets ”start tag” og ”slut tag” vil være synligt, når du åbner html-koden i en browser. Bemærk body elementet kan kun bruges en gang, derfor skal alt content, der skal vises på siden indsættes i mellem &lt;body&gt; og &lt;body/&gt;.  </p>
        ...
        <div id="footercontainer">
            ...
            <p class="tekst">Her et par eksempler om ”ikke” semantiske tags:</p>
            
            <p class="tekst"> Første eksempel er div (inddeling), som bruges til at inddele noget, der skal formateres på en bestemt måde, men fortæller ikke noget om indholdet. Derfor har det ingen betydning for indholdet. </p>    
