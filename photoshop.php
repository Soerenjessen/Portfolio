...
<html lang="da">
    ...
    <?php include "menu.inc" ?>    
        ...
        <div id="photoshop"> <!--Photoshop start-->
            ...
            <p class="tekst"> Det handler om at indrette sit workspace, så det er nemt og praktisk for dig. Det kan man gøre ved at placere de tools, som man bruger mest, der hvor det giver bedst mening. </p> 
              
        </div>  <!--Illustrator slut-->
            
        <div id="keyboard"> <!--Keyboard shortcuts start-->
            <h2> Keyboards Shortcuts</h2> 
            
                <p class="tekst"> De kan bruges til at gøre arbejdet nemmere og hurtigere.</p>
            
             <div id="shortcutcontainer">
            
                <img id="shortcuts" class="allebilleder" src="Billeder/shortcuts.jpg">
                
                <blockquote>Forskellige Shortcuts i Photoshop ↑</blockquote>            
            </div> 
            
            
        </div>  <!--Keyboard shortcuts slut-->
        ...
        <div id="artboards"> <!--Artboards start-->
            ...
            <div id="ghostcontainer"> 
                ...
                <img id="ghost" class="allebilleder" src="Billeder/ghost.jpg">
                
                <blockquote>Spøgelser i artboards ↑</blockquote>            
            </div> 
        ...
        <div id="selections"> <!--Selection start-->
            ...
            <div id="quickcontainer"> 
                ...
                <img id="quick" class="allebilleder" src="Billeder/quick.jpg">
                
                <blockquote>Sådan ser Quick Selection-Tool ud ↑</blockquote>            
            </div> 
        ...
        <div id="pen"> <!--Pen Tool start-->
            ...
            <div id="pentoolcontainer"> 
                ...
                <img id="pentool" class="allebilleder" src="Billeder/pentool.jpg">
                
                <blockquote>Sådan ser Pen-Tool ud ↑</blockquote>            
            </div> 
            ...
            <div id="felt20"> &nbsp;</div> <!--holder footer nede på siden-->     
        </div> <!--pagewrap slut-->
